<div class="cv-preview" markdown="1">
<div class="image-container">
  <div class="image-wrapper">
    <img src="/images/cv/cv-picture.jpg" alt="cv-picture.jpg">
  </div>
<h1> ROZHAN TEYMOURTASHLOO </h1>
</div>

---

| <iconify-icon inline icon="ic:outline-location-on"></iconify-icon> LATINA, ITALY | <iconify-icon inline icon="tabler:mail"></iconify-icon> [rteymourtashloo@gmail.com](https://rozhanteymourtashloo.com/cv) |
| <iconify-icon inline icon="charm:person"></iconify-icon> [rozhanteymourtashloo.com](https://rozhanteymourtashloo.com/) | <iconify-icon inline icon="tabler:brand-linkedin"></iconify-icon> [linkedin.com/in/rozhanteymourtashloo](https://linkedin.com/in/rozhanteymourtashloo/) |
...
- Designed sustainable, accessible, and community-focused urban green spaces in partnership with municipal parks
- Collaborated with municipal stakeholders to ensure alignment with city planning and foster public engagement
...
- Led vegetation planning and landscape design projects, delivering tailored solutions for clients

## Education

| **MASTER OF LANDSCAPE ARCHITECTURE (M.L.A.)** | **OCT 2021 - DEC 2024** |
| University of Sapienza | Rome, Italy |
| **BACHELOR OF LANDSCAPE ARCHITECTURE (B.L.A.)** | **OCT 2017 - JUL 2021** |
